...
public class Code4Life {
	public static void main(String[] args) {
		...
		String input = JOptionPane.showInputDialog("How many hours did you spent on coding this week?");
		...
		if (hours >= 3 && hours < 5) {
			...
			JOptionPane.showMessageDialog(null, "Stop waching YouTube and write code.");
		} else {
